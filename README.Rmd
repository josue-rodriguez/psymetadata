...
## Adding a dataset
If you'd like to contribute a dataset to this package please fork the repository and do the following steps:
...
### 2)
Assign your dataset to an object with the format `[firstauthor][year]`your dataset to the `data` folder with the format `[firstauthor][year].rda`, e.g.
...
### 3)
Add a bibtex reference to `inst/REFERENCES.bib` file. This can be easily obtained with a citation manager (e.g., Zotero) or with Google scholar 
