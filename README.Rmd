...
You can install released version of `psymetadata` from [CRAN](https://CRAN.R-project.org) with:

```{r}
install.packages("psymetadata")
```

If you want to install the most recent development version from GitHub, use the following code:
